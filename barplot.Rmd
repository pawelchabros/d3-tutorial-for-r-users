...
Axis bottom means that labels and ticks are on the bottom of the axis. D3 is not aware what's your chart height, so it put's it at (0, 0) coordinates. It's our duty to put it in right place. We can do it using `transform` attribute:
